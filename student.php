...
$transid = mysqli_real_escape_string($conn,$_POST['transid']);
  $q1 = $conn->query("INSERT INTO student (sname,joindate,contact,about,emailid,grade,balance,fees,transid,paid) VALUES ('$sname','$joindate','$contact','$about','$emailid','$grade','$balance','$fees','$transid ','$advancefees')") ;
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Manage Students <br>
						<?php
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-success">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
								<label class="col-sm-2 control-label" for="Password" >Transaction ID* </label>
								<div class="col-sm-10">
								<input type="text" class="form-control" id="sname" name="transid" value="<?php echo $transid;?>"  />
						...
						?>
							<div class="form-group">
								...
								<div class="col-sm-10">
	                        <textarea class="form-control" id="remark" name="remark" placeholder="Write your installment number or full paid"><?php echo $remark;?></textarea >
								</div>
							</div>
						<?php
						}
                            ...
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr '.(($r['balance']>0)?'class="primary"':'').'>
											...
											<a href="?action=edit&id='.$r['id'].'" class="btn btn-success btn-xs" style="border-radius:60px;"><span class="glyphicon glyphicon-edit"></span></a>

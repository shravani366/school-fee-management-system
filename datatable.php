...
{
$aColumns = array( 's.id','s.sname','s.transid','s.balance','s.fees','s.paid','b.grade','s.contact','s.joindate');
...
if($_GET['type']=="report")
{
$aColumns = array( 's.id','s.sname','s.transid','s.fees','s.paid','s.balance','b.grade','s.contact','S.joindate');

...
$sql = "select fees,balance,transid,paid  from student where id = '$sid'";
$sq = $conn->query($sql);
$sr = $sq->fetch_assoc();
$totalfee = $sr['fees'];
if($sr['balance']>0)
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Contact</th><th>Transid</th><th>Fees</th><th>paid</th><th>Balance</th><th>class</th>th>DOJ</th><th>Action</th></tr></thead><tbody></tbody></table>');
